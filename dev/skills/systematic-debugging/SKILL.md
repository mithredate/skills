...
3. **Verify Fix**
   ...
   - Use the `dev:verification-before-completion` skill before claiming success
...
These techniques are part of systematic debugging and live under `references/` and `scripts/`:
